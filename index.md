...
## ACM Multimedia: Call for Reproducibility Papers

[//]: # (The authors who already have a paper accepted at ACM Multimedia &#40;as a regular long/short paper or a special session paper&#41; can participate in the reproducibility review process.)
...
The companion paper will be formally reviewed by the [ACM Multimedia Reproducibility Committee]() or reviewers. 
...
The authors of an accepted reproducibility paper present their work as part of a specific reproducibility poster session at ACM Multimedia.

Please visit the page for information about the [ACM Multimedia 2026](./cfp2026/) call for reproducibility papers. You will find there the submission guidelines this year, the timeline, the paper badge, the description of the companion paper, and the artifacts associated with this companion paper.
...
It is the [ACM Multimedia Reproducibility Committee](./cfp2026/#2026-reproducibility-committee) that is carrying out the review process, determining whether or not a paper will receive a badge. 
...
## ACM Multimedia Reproducibility Committee
...
The committee in charge of reproducibility at the 2026 edition of ACM Multimedia is provided in the page of [ACM Multimedia 2026 — Call for Reproducibility papers]({{site.baseurl}}/cfp2026).

---

## References

The process described in these pages was originally designed and implemented by Laurent Amsaleg, General Chair and Reproducibility Chair of ACM Multimedia 2019, with inputs from co-chairs Martha Larson, Benoit Huet, and Björn Þór Jónsson. The text here originated from the original web page for [ACM MM Reproducibility](https://project.inria.fr/acmmmreproducibility). The website is based on the Web page for [ACM ICMR Reproducibility](https://icmr-reproducibility.github.io/website/).
