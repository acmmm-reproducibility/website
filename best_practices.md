...
5. The scripts needed to transform the raw experimental data into the graphs, tables, plots, ..., that can be found in the original submission already published in the proceedings of ACM Multimedia.
